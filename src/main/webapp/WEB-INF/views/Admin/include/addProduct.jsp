...
function myFunction() {
	...
	if(mm<10) mm='0'+mm;
	v=(yyyy+'-'+mm+'-'+dd);
  var x = document.getElementById("manufacture_date").max=v;
							...
							<div class="col-lg-4">
								...
								<div class="input-group">
									<input id="manufacture_date" name="mdate"
										class="form-control text-center" type="date" onclick="myFunction()" max />
								</div>
							</div>
						...
						<div class="row form-group">
							...
							<div class="col-lg-4">
								<label class="col control-label text-center" for="image">Product
									Image<b color="red">*</b></label> <input type="file" id="myFile" name="image" required>
							</div>
						</div>
						<hr>
						<hr>
