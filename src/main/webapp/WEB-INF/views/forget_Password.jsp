...
<div id="container" class="container">
		...
		<div class="row">
			...
			<div class="col align-items-center flex-col sign-in">
				...
				<form action='<spring:url value="/sendotp"/>' method="post">
					<div class="form sign-in">
						<h3 style="color:red;">${requestScope.error}</h3>
						<div class="input-group">
							<i class='bx bxs-user'></i>
							<input type="email" name="email" placeholder="example@gmail.com" value="${sessionScope.email}">
						</div>
						<button>
							Send OTP
						</button>
						</form>
						<form action='<spring:url value="/verifyotp"/>' method="post">
						<div class="input-group">
							<i class='bx bxs-lock-alt'></i>
							<input type="password" name="otp" placeholder="Enter Your Otp">
						</div>
						<button>
							Verify
						</button>
